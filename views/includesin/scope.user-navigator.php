  ...
  <div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav">
        ...
        <!-- <li class="sidebar-item">
          <a class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false" href="gestion-grupos">
            <i class="fas fa-users"></i>
            <span class="hide-menu">Grupos</span>
          </a>
        </li> -->
        <li class="sidebar-item">
          <a class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false" href="gestion-proyectos">
            <i class="fas fa-project-diagram"></i>
            <span class="hide-menu">Proyectos</span>
          </a>
          </li>
        <li class="sidebar-item">
          <a class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false" href="programas-formacion">
            <i class="fas fa-th-list"></i>
            <span class="hide-menu">Programas de formacion</span>
          </a>
        </li>
      </ul>
    </nav>
