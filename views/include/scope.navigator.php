<aside class="left-sidebar aside">
        ...
        <li>
          <div class="user-profile d-flex no-block dropdown m-t-20">
            ...
            <div class=" user-content hide-menu m-l-10 alinear">
              <a class="text-light" href="adminstracion">

                <h2 class="hide-menu">Base</h2>
              </a>
            </div>
          </div>
        </li>
  ...
  <!-- Sidebar scroll-->
  <div class="scroll-sidebar" style="background:gray;">
    <!-- Sidebar navigation-->
    <nav class="sidebar-nav">
      <ul id="sidebarnav">
        <li>
          <!-- User Profile-->
          <div class="user-profile d-flex no-block dropdown m-t-20">
            <div class="user-pic"><i class="fas fa-user" width="40"></i></div>
